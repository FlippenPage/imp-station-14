...
using Content.Server._EinsteinEngines.BloodCult.Items.BloodSpear;
using Content.Server._EinsteinEngines.BloodCult.Objectives;
using Content.Server._EinsteinEngines.BloodCult.RendingRunePlacement;
using Content.Server._EinsteinEngines.BloodCult.Spells;
...
using Content.Shared._EinsteinEngines.BloodCult.Components;
using Content.Shared._EinsteinEngines.BloodCult.BloodCultist;
using Content.Shared._EinsteinEngines.BloodCult.Items;
...
namespace Content.Server._EinsteinEngines.BloodCult.Gamerule;
...
public sealed class BloodCultRuleSystem : GameRuleSystem<BloodCultRuleComponent>
{
    ...
    public void Convert(EntityUid target)
    {
        ...
        while (query.MoveNext(out var ruleUid, out _, out _, out _))
        {
            ...
            _antagSelection.MakeAntag(antagSelectionEnt, actor.PlayerSession, def.Value, null);
        }
    }

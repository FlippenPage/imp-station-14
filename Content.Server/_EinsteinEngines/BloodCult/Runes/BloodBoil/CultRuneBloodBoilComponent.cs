...
namespace Content.Server._EinsteinEngines.BloodCult.Runes.BloodBoil;
...
public sealed partial class CultRuneBloodBoilComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier ActivationSound = new SoundPathSpecifier("/Audio/_EinsteinEngines/BloodCult/magic.ogg");
}

...
namespace Content.Server._EinsteinEngines.BloodCult.Runes.Rending;
...
public sealed partial class CultRuneRendingComponent : Component
{
    ...
    public SoundSpecifier FinishedDrawingAudio =
        new SoundPathSpecifier("/Audio/_EinsteinEngines/BloodCult/rending_draw_finished.ogg");

    [DataField]
    public SoundSpecifier SummonAudio = new SoundPathSpecifier("/Audio/_EinsteinEngines/BloodCult/rending_ritual.ogg");

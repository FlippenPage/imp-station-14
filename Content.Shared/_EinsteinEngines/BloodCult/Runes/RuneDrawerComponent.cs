...
public sealed partial class RuneDrawerComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier StartDrawingSound = new SoundPathSpecifier("/Audio/_EinsteinEngines/BloodCult/butcher.ogg");

    public SoundSpecifier EndDrawingSound = new SoundPathSpecifier("/Audio/_EinsteinEngines/BloodCult/blood.ogg");
}

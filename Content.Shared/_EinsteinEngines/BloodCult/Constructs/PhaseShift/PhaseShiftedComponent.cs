...
namespace Content.Shared._EinsteinEngines.BloodCult.Constructs.PhaseShift;
...
public sealed partial class PhaseShiftedComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier PhaseInSound = new SoundPathSpecifier(new ResPath("/Audio/_EinsteinEngines/BloodCult/veilin.ogg"));

    [DataField]
    public SoundSpecifier PhaseOutSound =
        new SoundPathSpecifier(new ResPath("/Audio/_EinsteinEngines/BloodCult/veilout.ogg"));

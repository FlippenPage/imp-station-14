using Content.Server._EinsteinEngines.BloodCult.Constructs.PhaseShift;
using Content.Shared.StatusEffect;
using Content.Shared._EinsteinEngines.BloodCult.Spells;
using Robust.Server.Audio;
using Robust.Server.GameObjects;
using Robust.Shared.Map;
using Robust.Shared.Map.Components;
using PhaseShiftedComponent = Content.Shared._EinsteinEngines.BloodCult.Constructs.PhaseShift.PhaseShiftedComponent;

namespace Content.Server._EinsteinEngines.BloodCult;
